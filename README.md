...
En mode connecté, la grille « Follows en direct » se remplit toute seule avec les chaînes suivies qui diffusent. Elle est verrouillée : impossible d’y ajouter ou d’en retirer une tuile, une chaîne qui s’arrête disparaît après une minute et une chaîne qui démarre arrive d’elle-même. À partir de neuf tuiles, elles démarrent en pause pour ménager le navigateur ; le bouton play global ou celui d’une tuile les lance. Le son, le volume, les pauses et l’ordre restent enregistrés d’une visite à l’autre.
...
Pendant le premier chargement des follows ou une recherche, des lignes fantômes remplissent la liste. Tant que le statut d’un favori n’est pas revenu, sa ligne de catégorie pulse. Le survol d’une chaîne en direct ouvre, après un court délai, une carte avec l’image du stream, sa catégorie, son titre et ses spectateurs ; l’aperçu vidéo muet se charge ensuite, un anneau tourne autour de l’avatar en attendant. La carte suit le pointeur de ligne en ligne et s’efface en fondu.

Le statut des favoris est vérifié au chargement, puis toutes les 30 secondes tant que la page est visible. Le serveur garde les réponses en cache une minute. Une chaîne hors ligne apparaît grisée, même si elle n’a pas diffusé depuis longtemps. Quand un stream ouvert dans la grille se termine, sa tuile attend une minute puis disparaît, avec un message dans la sidebar, sauf si elle est en spotlight ou si la grille est verrouillée. Le retour en direct pendant cette minute annule le retrait. Une chaîne ajoutée alors qu’elle était déjà hors ligne reste en place et attend son direct. Une tuile hors ligne affiche la bannière que le streamer a configurée pour son écran hors ligne, ou un fond sombre, avec son avatar et la mention « Hors ligne » par-dessus. Ses boutons play/pause ne font rien, et les boutons globaux la laissent tranquille.
...
Le bouton « Spotlight » de la barre d’une tuile affiche le lecteur Twitch complet, avec ses réglages de qualité, son volume, sa pause et son plein écran ; un second clic ramène à la grille. C’est le seul déclencheur du spotlight : un clic sur la vidéo ne fait que relancer une tuile en pause. Les autres tuiles reçoivent aussi le lecteur complet dès que leur vidéo fait au moins 640 pixels de large, et leur chat quand la tuile fait 640 pixels ou laisse 420 pixels libres sous la vidéo ; elles les gardent jusqu’à 560 pixels, pour qu’une fenêtre proche de la limite ne fasse pas clignoter les lecteurs. Un changement dû à la taille attend 300 millisecondes après la fin du redimensionnement. Les petites tuiles gardent les commandes simplifiées. Les changements de volume, de son et de pause faits dans le lecteur sont conservés au retour à la grille.

La barre de chaque tuile porte un bouton play/pause et un bouton son. Le son a deux états, muet ou allumé, et un son allumé à la main reste allumé quoi que fasse le spotlight. Passer en spotlight allume le son de la tuile et mémorise l’état qu’elle avait ; en sortant, elle le retrouve, même si tu l’as coupée entre-temps. Les autres tuiles gardent leur son. Le volume apparaît sous le bouton son au survol ou au focus clavier, en curseur vertical. Le bouton global play/pause est un raccourci : pause met toutes les tuiles en pause, play les relance toutes, et chaque tuile peut ensuite reprendre ou se mettre en pause seule. Le bouton global muet est un verrou : tant qu’il est actif, les boutons son et les volumes des tuiles sont désactivés et l’expliquent dans leur infobulle. Le glisser des barres réordonne la grille ; déposer une tuile sur le spotlight lui prend la place, l’ancienne retourne dans la grille à sa position. Les libellés des boutons s’affichent dans une infobulle au survol ou au focus clavier.
...
Une tuile en pause, globale ou individuelle, garde une image du stream, rafraîchie chaque minute, au lieu d’un lecteur inactif ; son survol lance un aperçu muet dans la tuile, avec un anneau autour de l’avatar pendant le chargement, et la libère en partant. Une tuile qui doit jouer affiche un loader jusqu’à ce que la vidéo tourne vraiment, puis l’efface en fondu ; un clic sur ce loader ne fait rien. Si le lecteur est prêt depuis plusieurs secondes sans démarrer, ou si Twitch refuse la lecture, le loader laisse place à un bouton play sur l’image du stream, et le clic atteint le lecteur Twitch, dont le geste débloque la lecture.
