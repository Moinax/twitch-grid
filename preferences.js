...
const translations = {
  ...
  'Revenir à la grille':['Back to grid','Terug naar het raster'], 'Déposer ici':['Drop here','Hier neerzetten'], 'Spotlight':['Spotlight','Spotlight'],
  ...
  'Allumer le son':['Turn the sound on','Geluid aanzetten'], 'Épingler le son':['Pin the sound','Geluid vastzetten'], 'Couper le son':['Mute','Geluid uitzetten'],
  ...
  'Les chaînes en direct passent en tête de liste, statut vérifié toutes les 30 secondes. Un clic, et le stream rejoint la grille ; un stream terminé la quitte tout seul après une minute.':['Live channels move to the top of the list, with their status checked every 30 seconds. One click adds the stream to the grid; a stream that ends leaves it by itself after a minute.','Live kanalen staan bovenaan de lijst, met een statuscontrole elke 30 seconden. Eén klik zet de stream in het raster; een afgelopen stream verlaat het vanzelf na een minuut.'],
  'Un seul son à la fois':['One sound at a time','Eén geluid tegelijk'],
  'Le stream en spotlight a le son, les autres restent muets. Épingle le son d’une tuile pour le garder quand le spotlight change.':['The spotlighted stream has the sound, the others stay muted. Pin a tile’s sound to keep it when the spotlight moves.','De stream in de spotlight heeft het geluid, de andere blijven stil. Zet het geluid van een tegel vast om het te houden als de spotlight verandert.'],
  'Une grille qui se souvient':['A grid that remembers','Een raster dat onthoudt'],
  'Son épinglé, grilles nommées, chat et disposition : tout est enregistré dans ton navigateur et revient tel quel.':['Pinned sound, named grids, chat and layout: everything is saved in your browser and comes back as you left it.','Vastgezet geluid, benoemde rasters, chat en indeling: alles wordt in je browser bewaard en komt terug zoals je het achterliet.'],
  'Twitch grid en une phrase':['Twitch grid in one sentence','Twitch grid in één zin'],
  'Un stream en spotlight, les autres sous la main. Le son que tu choisis, la grille qui s’en souvient.':['One stream up front, the others within reach. The sound you choose, the grid that remembers it.','Eén stream vooraan, de andere binnen handbereik. Het geluid dat jij kiest, het raster dat het onthoudt.'],
  ...
  'Passe un stream en spotlight : grand, avec le son et le lecteur Twitch complet. Toute autre tuile assez large reçoit aussi le lecteur complet.':['Spotlight a stream: big, with the sound and the full Twitch player. Any other tile wide enough gets the full player too.','Zet een stream in de spotlight: groot, met geluid en de volledige Twitch-speler. Elke andere tegel die breed genoeg is, krijgt de volledige speler ook.'],
  'Son en trois états':['Sound in three states','Geluid in drie standen'],
  'Muet, allumé ou épinglé, sur chaque tuile. Allumé suit le spotlight, épinglé reste. Un bouton coupe tout, un autre met tout en pause.':['Muted, on or pinned, on every tile. On follows the spotlight, pinned stays. One button mutes everything, another pauses everything.','Stil, aan of vastgezet, op elke tegel. Aan volgt de spotlight, vastgezet blijft. Eén knop dempt alles, een andere pauzeert alles.'],
  ...
  'Le chat s’ouvre à côté de toute tuile assez large : auto, haut, bas, gauche ou droite, mémorisé par stream.':['The chat opens next to any tile wide enough: auto, top, bottom, left or right, remembered per stream.','De chat opent naast elke tegel die breed genoeg is: auto, boven, onder, links of rechts, onthouden per stream.'],
  'Grille verrouillée':['Locked grid','Vergrendeld raster'],
  'Verrouille la grille pour qu’aucun stream ne s’ajoute par erreur. Un stream terminé quitte la grille après une minute.':['Lock the grid so no stream joins by accident. A stream that ends leaves the grid after a minute.','Vergrendel het raster zodat geen stream per ongeluk wordt toegevoegd. Een afgelopen stream verlaat het raster na een minuut.'],
  'Agrandir':['Enlarge','Vergroten'],
  'Étends le stream en spotlight à toute la fenêtre du navigateur. Échap pour revenir.':['Stretch the spotlighted stream to the whole browser window. Escape brings you back.','Rek de uitgelichte stream uit tot het hele browservenster. Escape brengt je terug.'],
  ...
  'Repliée, la liste devient un rail d’avatars, directs marqués en rouge. Le survol ouvre un aperçu du stream avec son titre et sa catégorie.':['Folded, the list becomes a rail of avatars with live channels marked in red. Hovering opens a preview of the stream with its title and category.','Ingeklapt wordt de lijst een rail van avatars, met live kanalen in het rood. Aanwijzen opent een voorbeeld van de stream met titel en categorie.'],
  ...
  'Choisis le spotlight et le son':['Pick the spotlight and the sound','Kies de uitgelichte stream en het geluid'],
  'Passe une vidéo en spotlight. Le son la suit, le reste se tait.':['Spotlight a video. The sound follows it, the rest goes quiet.','Klik op een video om hem uit te lichten. Het geluid volgt, de rest zwijgt.'],
  ...
  'Pourquoi certaines tuiles ont le lecteur Twitch complet et d’autres non ?':['Why do some tiles have the full Twitch player and others not?','Waarom hebben sommige tegels de volledige Twitch-speler en andere niet?'],
  'Dès qu’une tuile est assez large, elle reçoit le lecteur complet et, plus large encore, son chat. Réduis la fenêtre et elle repasse aux commandes simplifiées, sans rien perdre.':['As soon as a tile is wide enough it gets the full player and, wider still, its chat. Shrink the window and it goes back to the simplified controls without losing anything.','Zodra een tegel breed genoeg is, krijgt hij de volledige speler en, nog breder, zijn chat. Verklein het venster en hij gaat terug naar de vereenvoudigde knoppen zonder iets te verliezen.'],
  ...
  'Passe en spotlight, choisis le son':['Spotlight it, pick the sound','Licht uit, kies het geluid'],
  ...
  '{name} est hors ligne, la tuile a été retirée.':['{name} is offline, the tile was removed.','{name} is offline, de tegel is verwijderd.'],
