...
const translations = {
  ...
  'Couper tous les sons':['Mute every stream','Alle geluiden dempen'], 'Son coupé globalement':['Sound muted for every stream','Geluid voor alle streams gedempt'], 'Réactiver le son':['Restore the sound','Geluid herstellen'],
  ...
  'Retirer':['Remove','Verwijderen'], 'Son':['Audio','Geluid'], 'Volume':['Volume','Volume'], 'Play/pause':['Play/pause','Afspelen/pauzeren'], 'Lecture':['Play','Afspelen'], 'Pause':['Pause','Pauze'],
  ...
  'Allumer le son':['Turn the sound on','Geluid aanzetten'], 'Couper le son':['Mute','Geluid uitzetten'],
