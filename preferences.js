...
const translations = {
  'Réglages':['Settings','Instellingen'], 'Langue':['Language','Taal'], 'Thème':['Theme','Thema'],
  'Système':['System','Systeem'], 'Clair':['Light','Licht'], 'Sombre':['Dark','Donker'],
  ...
  'Nouvelle grille':['New grid','Nieuw raster'], 'Nom de la grille':['Grid name','Naam van het raster'],
  ...
  'Les lecteurs et le chat gardent la langue de Twitch.':['Players and chat keep Twitch’s language.','Spelers en chat behouden de taal van Twitch.'],
  'Le thème système suit ton système d’exploitation.':['The system theme follows your operating system.','Het systeemthema volgt je besturingssysteem.'],
  ...
  'Les favoris sont enregistrés dans ce navigateur.':['Favorites are saved in this browser.','Favorieten worden in deze browser opgeslagen.'],
  'Ta liste de follows se met à jour automatiquement.':['Your followed channels update automatically.','Je gevolgde kanalen worden automatisch bijgewerkt.'],
