...
const translations = {
  ...
  'Repliée, la liste devient un rail d’avatars, chaînes hors ligne estompées. Le survol ouvre un aperçu du stream avec son titre et sa catégorie.':['Folded, the list becomes a rail of avatars with offline channels dimmed. Hovering opens a preview of the stream with its title and category.','Ingeklapt wordt de lijst een rail van avatars, met offline kanalen gedimd. Aanwijzen opent een voorbeeld van de stream met titel en categorie.'],
